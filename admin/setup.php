...
if($action == 'save')
{
	$position_facture_client = intval(GETPOST('position_facture_client', 'int'));
	$position_facture_proposition_commerciale = intval(GETPOST('position_facture_proposition_commerciale', 'int'));
	$position_facture_commande_client = intval(GETPOST('position_facture_commande_client', 'int'));
	$position_facture_commande_fourniseure = intval(GETPOST('position_facture_commande_fourniseure', 'int'));
	$position_facture_proposition_commerciale_fournisseur = intval(GETPOST('position_facture_proposition_commerciale_fournisseur', 'int'));
	$position_facture_fournisseur = intval(GETPOST('position_facture_fournisseur', 'int'));
...
print '<option value="1"'.($conf->global->position_facture_client == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_client == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
...
print '<option value="1"'.($conf->global->position_facture_fournisseur == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_fournisseur == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
...
print '<option value="1"'.($conf->global->position_facture_proposition_commerciale == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_proposition_commerciale == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
...
print '<option value="1"'.($conf->global->position_facture_commande_client == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_commande_client == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
...
print '<option value="1"'.($conf->global->position_facture_commande_fourniseure == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_commande_fourniseure == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
...
print '<option value="1"'.($conf->global->position_facture_proposition_commerciale_fournisseur == 1 ? ' selected="selected"' : '').'>Droit</option>';
print '<option value="2"'.($conf->global->position_facture_proposition_commerciale_fournisseur == 2 ? ' selected="selected"' : '').'>Bas</option>';
print '</select>';
print '  </td>';
print '</tr>';
